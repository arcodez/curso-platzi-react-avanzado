...
export function Logo (props) {
  return (
    <Svg
      ...
      viewBox='-52.57 13.989 605.14 122.021'
      style={{
        background: '0 0'
      }}
    ...
    >
      <defs>
        ...
        >
          <stop offset={0} stopColor='#56ff00' />
          <stop offset={1} stopColor='#27b8b8' />
        </linearGradient>
        <filter
